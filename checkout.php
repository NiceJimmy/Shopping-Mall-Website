...
<script type="text/javascript" src="https://service.iamport.kr/js/iamport.payment-1.1.5.js"></script>
    ...
    <body>
      ...
      <a class="btn btn-primary" href="http://localhost/cart.php"><span class="glyphicon glyphicon-pencil"></span>결제 취소하기</a>
              </li>
            </ol>
          </div>
      </div>
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title">
                <i class="fa fa-money fa-fw"></i> 결제정보
              </h3>
            </div>
...
<p>
    ...
    <button id="check_module" type="button">결제 진행하기</button>
</p>
<script>
    $("#check_module").click(function () {
        var IMP = window.IMP; // 생략가능
        IMP.init('imp90679677');
