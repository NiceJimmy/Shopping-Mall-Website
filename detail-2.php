    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <div class="list-group">
          <a href="http://localhost/main.html" class="list-group-item active">ALL</a>
...
error_reporting(E_ALL & ~E_NOTICE);
  ...
  <form action="edit_product.php?pro_id=<?php echo $product_id; ?>" class="form-horizental" method="post">
     ...
     <p class="text-center buttons"><button class="btn btn-primary i fa fa-shopping-cart">Edit Info</button></p>
