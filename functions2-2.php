...
<div class='col-md-4 col-sm-6 single'>
    ...
    <div class='product'>
       ...
       <a href='detail-2.php?pro_id=$pro_id'>
    ...
    <p class='button'>
      <a class='btn btn-default' href='detail-2.php?pro_id=$pro_id'> View Details </a>
    <a class='btn btn-primary' href='edit_product.php?pro_id=$pro_id'>
    <i class='fa fa-shopping-cart'></i> Edit Info
    </a>
    </p>
